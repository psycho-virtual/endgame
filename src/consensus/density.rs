...
use super::Consensus;
use crate::accumulator::reed_solomon::RSProof;
...
impl DensityConsensus {
    ...
    pub fn expected_slots(&self, start_time: u64, end_time: u64) -> u64 {
    ...
    pub fn window_density(&self, blocks: &[Block], start_slot: u64, end_slot: u64) -> f64 {
